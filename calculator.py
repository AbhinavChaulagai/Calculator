...
class Calculator(Tk):
    ...
    def typer(self):
        ...
        self.scvalue.set("")
        self.screen = Entry(self, textvar=self.scvalue, font="lucida 35 bold")
    ...
    def btns(self):
        ...
        for i in range(0, 9):
            self.btn = Button(self.f, text=f"{i+1}", font="lucida 20 bold", width=4, height=1, relief=SUNKEN, borderwidth=3)
            self.btn.grid(row=rowk[i], column=colk[i], sticky=NSEW, padx=5, pady=5)
            self.btn.bind('<Button-1>', self.click)

        self.btn0 = Button(self.f, text="0", font="lucida 20 bold", width=4, height=1, relief=SUNKEN, borderwidth=3)
        self.btn0.grid(row=4, column=1, sticky=NSEW, padx=5, pady=5)
        self.btn0.bind('<Button-1>', self.click)
        self.btne = Button(self.f, text="=", font="lucida 20 bold", width=4, height=1, relief=SUNKEN, borderwidth=3)
        ...
        for i in range(len(self.btns1)-1):
            self.btn1 = Button(self.f, text=f"{self.btns1[i]}", font="lucida 20 bold", width=4, height=1, relief=SUNKEN, borderwidth=3)
            self.btn1.grid(row=self.row2[i], column=self.col2[i], sticky=NSEW, padx=5, pady=5)
            self.btn1.bind('<Button-1>', self.click)
            self.btn2 = Button(self.f, text=f"{self.btns1[i]}", font="lucida 20 bold", width=4, height=1, relief=SUNKEN, borderwidth=3)
            self.btn2.grid(row=self.row2[i], column=self.col2[i], sticky=NSEW, padx=5, pady=5)
            self.btn2.bind('<Button-1>', self.click)
        self.btnac = Button(self.f, text="AC", font="lucida 20 bold", width=4, height=1, relief=SUNKEN, borderwidth=3)
